        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 w-full items-center">
          ...
          <div className="md:col-span-6 flex flex-col justify-center">
            <AnimatedContent
              ...
              delay={0.3}
            >
              {/* Semua konten disatukan dalam satu flex container */}
              <div className="flex flex-col gap-6 items-start">

                {/* Bagian Nama & Peran */}
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl md:text-4xl font-bold text-black whitespace-nowrap">Thareeq Ziad R</h1>
                  <RotatingText
                    texts={['Web Developer', 'Front-end', 'Back-end', 'Fullstack', 'Data Analyst', 'Machine Learning']}
                    mainClassName="px-3 md:px-4 bg-[#0097B2] text-white overflow-hidden py-1 md:py-2 justify-center rounded-lg text-2xl font-bold inline-flex"
                  />
                </div>
                ...
                {/* Bagian Deskripsi */}
                <p className="font-bold text-2xl text-black md:text-lg">
                  <DecryptedText
                ...
                <div className="mt-4 flex items-center gap-4">
                  <ElectricBorder color="#0097B2" speed={2} chaos={0.5} style={{ borderRadius: '8px' }}>
                    <Magnet magnetStrength={50}>
                      <a 
                        ...
                        className="bg-transparent border border-black hover:bg-[#007c92] text-black semibold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors"
                      >
                  ...
                  <Magnet magnetStrength={30}>
                    <a href="/about" className="font-semibold text-black hover:opacity-80 flex items-center gap-2 transition-opacity text-xl">
